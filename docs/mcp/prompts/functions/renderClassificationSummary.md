...
[UserContext-mcp-extension](../../../modules.md) / [mcp/prompts](../README.md) / renderClassificationSummary

# Function: renderClassificationSummary()

> **renderClassificationSummary**(`options`): `string`

Defined in: [src/mcp/prompts/index.ts:124](https://github.com/ErikPlachta/vscode-extension-mcp-server/blob/a4612cf11a8e4895364ff4492326833e37841da7/src/mcp/prompts/index.ts#L124)
