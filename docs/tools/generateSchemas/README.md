...
[mybusiness-mcp-extension](../../modules.md) / tools/generateSchemas

# tools/generateSchemas

Build-time generator for JSON schemas derived from TypeScript interfaces.
