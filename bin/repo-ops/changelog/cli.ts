 ...
 *
 * Commands:
 *   tsx bin/repo-ops/changelog/cli.ts insert-markers [--file CHANGELOG.md]
 *   tsx bin/repo-ops/changelog/cli.ts add-entry --type docs --summary "Some summary" [--file CHANGELOG.md]
 *   tsx bin/repo-ops/changelog/cli.ts add-outstanding --priority 3 --text "Document future work"
 */
