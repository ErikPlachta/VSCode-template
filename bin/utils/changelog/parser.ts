...
export function insertOutstandingItem(
  ...
  if (insertAt === headingIdx + 1) {
    // We're at the first insertion point after heading. If a blank line follows the heading, skip it; otherwise, keep as-is.
    // We will not inject an extra blank line—just insert the bullet directly.
  } else {
